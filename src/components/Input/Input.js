                ...
                <li key={person.title}>
                  <div className="space-y-4">
                    <div className="aspect-w-3 aspect-h-2">
                      <img className="rounded-lg object-cover shadow-lg" src={person.image} alt="" />
                    </div>
                    ...
                    <ul role="list" className="flex space-x-5">
                      <li>
                        <a href={person.title} className="text-gray-400 hover:text-gray-500">
                      ...
                      <li>
                        <a href={person.ingredient} className="text-gray-400 hover:text-gray-500">
                          <span className="sr-only">{person.title}</span>
                          <svg className="h-5 w-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                            <path
                              fillRule="evenodd"
